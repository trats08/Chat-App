...
import 'package:chattie/pages/auth/profile_page.dart';
import 'package:chattie/pages/search_page.dart';
import 'package:chattie/services/auth_service.dart';
import 'package:chattie/services/database_service.dart';
import 'package:chattie/widgets/group_tile.dart';
              ...
              if(snapshot.data['groups'].length != 0){
                return ListView.builder(
                    ...
                    itemBuilder: (context,index){
                      ...
                      return GroupTile(groupId: getId(snapshot.data['groups'][revIndex]), groupName: getName(snapshot.data['groups'][revIndex]), userName: snapshot.data['fullName']);
                    });
              }
              else{
